...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class Texture2D : Texture
    {
        ...
        public float WidthReciprocal { get; private set; }
        public float HeightReciprocal { get; private set; }
        ...
        protected Texture2D(GraphicsDevice graphicsDevice, int width, int height, bool mipmap, SurfaceFormat format, SurfaceType type, bool shared, int arraySize)
		{
            ...
            this.width = width;
            this.height = height;
            this.WidthReciprocal = 1f / (float)width;
            this.HeightReciprocal = 1f / (float)height;
