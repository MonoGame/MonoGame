...
#endif
    public struct SRgb8A8Etc2 : IPackedVector<uint>, IEquatable<SRgb8A8Etc2>, IPackedVector
    {
        /// <inheritdoc />
        ...
        public SRgb8A8Etc2(float x, float y, float z, float w)
        {
        ...
        /// </param>
        public SRgb8A8Etc2(Vector4 vector)
        {
        ...
        {
            return obj is SRgb8A8Etc2 other && Equals(other);
        }

        /// <inheritdoc />
        public bool Equals(SRgb8A8Etc2 other)
        {
        ...
        public static bool operator ==(SRgb8A8Etc2 lhs, SRgb8A8Etc2 rhs)
        {
