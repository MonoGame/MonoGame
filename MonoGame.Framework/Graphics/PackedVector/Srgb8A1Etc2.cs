...
#endif
    public struct Srgb8A1Etc2 : IPackedVector<uint>, IEquatable<Srgb8A1Etc2>, IPackedVector
    {
        /// <inheritdoc />
        ...
        public Srgb8A1Etc2(float x, float y, float z, float w)
        {
        ...
        /// </param>
        public Srgb8A1Etc2(Vector4 vector)
        {
        ...
        {
            return obj is Srgb8A1Etc2 other && Equals(other);
        }

        /// <inheritdoc />
        public bool Equals(Srgb8A1Etc2 other)
        {
        ...
        public static bool operator ==(Srgb8A1Etc2 lhs, Srgb8A1Etc2 rhs)
        {
        ...
        private static uint Pack(float x, float y, float z, float w)
        {
            return (uint)(
                ...
                (((int)MathF.Round(MathHelper.Clamp(w, 0, 1)         ) & 0x01) << 24)
            );
        }
    }
}
