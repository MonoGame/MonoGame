...
namespace MonoGame.OpenGL
{
    internal partial class GL
    {
		...
		internal static IntPtr libES1 = FuncLoader.LoadLibrary("libGLESv1_CM.so");
        internal static IntPtr libES2 = FuncLoader.LoadLibrary("libGLESv2.so");
        internal static IntPtr libES3 = FuncLoader.LoadLibrary("libGLESv3.so");
        internal static IntPtr libGL = FuncLoader.LoadLibrary("libGL.so");
        ...
        static partial void LoadPlatformEntryPoints()
        {
            ...
            bool eglBindLoaded = false;
            try
            {
                BindAPI = FuncLoader.LoadFunction<BindAPIDelegate>(GL.Library, "eglBindAPI", true);
                eglBindLoaded = true;
            }
            catch { }
