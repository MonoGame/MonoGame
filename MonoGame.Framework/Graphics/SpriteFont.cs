...
namespace Microsoft.Xna.Framework.Graphics 
{
	...
	public sealed class SpriteFont 
    {
			                    ...
			                    float rotation, Vector2 origin, Vector2 scale, SpriteEffects effect, float depth)
		{
            ...
            mFlipOrigin.M33 = 1;
            mFlipOrigin.M34 = 0;
            mFlipOrigin.M41 = flipAdjustment.X - origin.X;
            mFlipOrigin.M42 = flipAdjustment.Y - origin.Y;
            mFlipOrigin.M43 = 0;
            mFlipOrigin.M44 = 1;
            Matrix mScale;
            mScale.M11 = (flippedHorz ? -scale.X : scale.X);
            mScale.M12 = 0;
            mScale.M13 = 0;
            mScale.M14 = 0;
            mScale.M21 = 0;
            mScale.M22 = (flippedVert ? -scale.Y : scale.Y);
            mScale.M23 = 0;
            mScale.M24 = 0;
            mScale.M31 = 0;
            mScale.M32 = 0;
            ...
            mScale.M43 = 0;
            mScale.M44 = 1;
            Matrix mFlipOriginScale = mFlipOrigin * mScale;
            mFlipOriginScale.M11 = (((mFlipOrigin.M11 * mScale.M11) + (mFlipOrigin.M12 * mScale.M21)) + (mFlipOrigin.M13 * mScale.M31)) + (mFlipOrigin.M14 * mScale.M41);
            mFlipOriginScale.M12 = (((mFlipOrigin.M11 * mScale.M12) + (mFlipOrigin.M12 * mScale.M22)) + (mFlipOrigin.M13 * mScale.M32)) + (mFlipOrigin.M14 * mScale.M42);
            mFlipOriginScale.M13 = (((mFlipOrigin.M11 * mScale.M13) + (mFlipOrigin.M12 * mScale.M23)) + (mFlipOrigin.M13 * mScale.M33)) + (mFlipOrigin.M14 * mScale.M43);
            mFlipOriginScale.M14 = (((mFlipOrigin.M11 * mScale.M14) + (mFlipOrigin.M12 * mScale.M24)) + (mFlipOrigin.M13 * mScale.M34)) + (mFlipOrigin.M14 * mScale.M44);
            mFlipOriginScale.M21 = (((mFlipOrigin.M21 * mScale.M11) + (mFlipOrigin.M22 * mScale.M21)) + (mFlipOrigin.M23 * mScale.M31)) + (mFlipOrigin.M24 * mScale.M41);
            mFlipOriginScale.M22 = (((mFlipOrigin.M21 * mScale.M12) + (mFlipOrigin.M22 * mScale.M22)) + (mFlipOrigin.M23 * mScale.M32)) + (mFlipOrigin.M24 * mScale.M42);
            mFlipOriginScale.M23 = (((mFlipOrigin.M21 * mScale.M13) + (mFlipOrigin.M22 * mScale.M23)) + (mFlipOrigin.M23 * mScale.M33)) + (mFlipOrigin.M24 * mScale.M43);
            mFlipOriginScale.M24 = (((mFlipOrigin.M21 * mScale.M14) + (mFlipOrigin.M22 * mScale.M24)) + (mFlipOrigin.M23 * mScale.M34)) + (mFlipOrigin.M24 * mScale.M44);
            mFlipOriginScale.M31 = (((mFlipOrigin.M31 * mScale.M11) + (mFlipOrigin.M32 * mScale.M21)) + (mFlipOrigin.M33 * mScale.M31)) + (mFlipOrigin.M34 * mScale.M41);
            mFlipOriginScale.M32 = (((mFlipOrigin.M31 * mScale.M12) + (mFlipOrigin.M32 * mScale.M22)) + (mFlipOrigin.M33 * mScale.M32)) + (mFlipOrigin.M34 * mScale.M42);
            mFlipOriginScale.M33 = (((mFlipOrigin.M31 * mScale.M13) + (mFlipOrigin.M32 * mScale.M23)) + (mFlipOrigin.M33 * mScale.M33)) + (mFlipOrigin.M34 * mScale.M43);
            mFlipOriginScale.M34 = (((mFlipOrigin.M31 * mScale.M14) + (mFlipOrigin.M32 * mScale.M24)) + (mFlipOrigin.M33 * mScale.M34)) + (mFlipOrigin.M34 * mScale.M44);
            mFlipOriginScale.M41 = (((mFlipOrigin.M41 * mScale.M11) + (mFlipOrigin.M42 * mScale.M21)) + (mFlipOrigin.M43 * mScale.M31)) + (mFlipOrigin.M44 * mScale.M41);
            mFlipOriginScale.M42 = (((mFlipOrigin.M41 * mScale.M12) + (mFlipOrigin.M42 * mScale.M22)) + (mFlipOrigin.M43 * mScale.M32)) + (mFlipOrigin.M44 * mScale.M42);
            mFlipOriginScale.M43 = (((mFlipOrigin.M41 * mScale.M13) + (mFlipOrigin.M42 * mScale.M23)) + (mFlipOrigin.M43 * mScale.M33)) + (mFlipOrigin.M44 * mScale.M43);
            mFlipOriginScale.M44 = (((mFlipOrigin.M41 * mScale.M14) + (mFlipOrigin.M42 * mScale.M24)) + (mFlipOrigin.M43 * mScale.M34)) + (mFlipOrigin.M44 * mScale.M44);
