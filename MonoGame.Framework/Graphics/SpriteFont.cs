...
namespace Microsoft.Xna.Framework.Graphics 
{
	...
	public sealed class SpriteFont 
    {
			                    ...
			                    float rotation, Vector2 origin, Vector2 scale, SpriteEffects effect, float depth)
		{
            ...
            mFlipOriginScaleRotation.M11 = ((((flippedHorz ? -scale.X : scale.X) * cos) + (0 * (-sin))) + (0 * 0)) + (0 * 0);
            mFlipOriginScaleRotation.M12 = ((((flippedHorz ? -scale.X : scale.X) * sin) + (0 * cos)) + (0 * 0)) + (0 * 0);
            mFlipOriginScaleRotation.M13 = ((((flippedHorz ? -scale.X : scale.X) * 0) + (0 * 0)) + (0 * 1)) + (0 * 0);
            mFlipOriginScaleRotation.M14 = ((((flippedHorz ? -scale.X : scale.X) * 0) + (0 * 0)) + (0 * 0)) + (0 * 1);
            mFlipOriginScaleRotation.M21 = (((0 * cos) + ((flippedVert ? -scale.Y : scale.Y) * (-sin))) + (0 * 0)) + (0 * 0);
            mFlipOriginScaleRotation.M22 = (((0 * sin) + ((flippedVert ? -scale.Y : scale.Y) * cos)) + (0 * 0)) + (0 * 0);
            mFlipOriginScaleRotation.M23 = (((0 * 0) + ((flippedVert ? -scale.Y : scale.Y) * 0)) + (0 * 1)) + (0 * 0);
            mFlipOriginScaleRotation.M24 = (((0 * 0) + ((flippedVert ? -scale.Y : scale.Y) * 0)) + (0 * 0)) + (0 * 1);
            mFlipOriginScaleRotation.M31 = (((0 * cos) + (0 * (-sin))) + (1 * 0)) + (0 * 0);
            mFlipOriginScaleRotation.M32 = (((0 * sin) + (0 * cos)) + (1 * 0)) + (0 * 0);
            mFlipOriginScaleRotation.M33 = (((0 * 0) + (0 * 0)) + (1 * 1)) + (0 * 0);
            mFlipOriginScaleRotation.M34 = (((0 * 0) + (0 * 0)) + (1 * 0)) + (0 * 1);
            mFlipOriginScaleRotation.M41 = (((((flipAdjustment.X - origin.X) * (flippedHorz ? -scale.X : scale.X)) * cos) + (((flipAdjustment.Y - origin.Y) * (flippedVert ? -scale.Y : scale.Y)) * (-sin))) + (0 * 0)) + (1 * 0);
            mFlipOriginScaleRotation.M42 = (((((flipAdjustment.X - origin.X) * (flippedHorz ? -scale.X : scale.X)) * sin) + (((flipAdjustment.Y - origin.Y) * (flippedVert ? -scale.Y : scale.Y)) * cos)) + (0 * 0)) + (1 * 0);
            mFlipOriginScaleRotation.M43 = (((((flipAdjustment.X - origin.X) * (flippedHorz ? -scale.X : scale.X)) * 0) + (((flipAdjustment.Y - origin.Y) * (flippedVert ? -scale.Y : scale.Y)) * 0)) + (0 * 1)) + (1 * 0);
            mFlipOriginScaleRotation.M44 = (((((flipAdjustment.X - origin.X) * (flippedHorz ? -scale.X : scale.X)) * 0) + (((flipAdjustment.Y - origin.Y) * (flippedVert ? -scale.Y : scale.Y)) * 0)) + (0 * 0)) + (1 * 1);
