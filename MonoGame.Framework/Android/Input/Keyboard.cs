...
namespace Microsoft.Xna.Framework.Input
{
	public static class Keyboard
	{
        ...
        private static IDictionary<Keycode, Keys> LoadKeyMap()
        {
            ...
            maps[Keycode.Numpad0] = Keys.NumPad0;
            maps[Keycode.Numpad1] = Keys.NumPad1;
            maps[Keycode.Numpad2] = Keys.NumPad2;
            maps[Keycode.Numpad3] = Keys.NumPad3;
            maps[Keycode.Numpad4] = Keys.NumPad4;
            maps[Keycode.Numpad5] = Keys.NumPad5;
            maps[Keycode.Numpad6] = Keys.NumPad6;
            maps[Keycode.Numpad7] = Keys.NumPad7;
            maps[Keycode.Numpad8] = Keys.NumPad8;
            maps[Keycode.Numpad9] = Keys.NumPad9;
            ...
            maps[Keycode.MetaLeft] = Keys.LeftWindows;
            maps[Keycode.MetaRight] = Keys.RightWindows;
            maps[Keycode.Menu] = Keys.Apps;
            maps[Keycode.Tab] = Keys.Tab;
            maps[Keycode.CapsLock] = Keys.CapsLock;
            maps[Keycode.Sysrq] = Keys.PrintScreen;
            maps[Keycode.ScrollLock] = Keys.Scroll;
            maps[Keycode.Break] = Keys.Pause;
            maps[Keycode.Insert] = Keys.Insert;
            maps[Keycode.Del] = Keys.Delete;
            maps[Keycode.MoveHome] = Keys.Home;
            maps[Keycode.MoveEnd] = Keys.End;
            ...
            maps[Keycode.Equals] = Keys.OemPlus;
            ...
            maps[Keycode.Apostrophe] = Keys.OemQuotes;
            maps[Keycode.Slash] = Keys.OemQuestion;
            maps[Keycode.Backslash] = Keys.OemPipe;
            ...
            maps[Keycode.NumpadEnter] = Keys.Enter;
            maps[Keycode.NumpadDot] = Keys.Decimal;
            ...
            maps[Keycode.VolumeMute] = Keys.VolumeMute;
            maps[Keycode.MediaPlay] = Keys.MediaPlayPause;
