...
namespace MonoGame.Framework.Devices.Sensors
{
    ...
    /// </summary>
    public class GyrometerFailedException : SensorFailedException
    {
        /// <summary>
        /// Initializes a new instance of GyrometerFailedException
        /// </summary>
        ...
        internal GyrometerFailedException(string message, int errorId)
            : base(message)
        {
            ErrorId = errorId;
        }
