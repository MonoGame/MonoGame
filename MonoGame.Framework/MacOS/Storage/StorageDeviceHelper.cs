	...
	internal class StorageDeviceHelper
	{
		...
		internal static long FreeSpace 
		{
			get {
				...
				try {
					free = long.Parse(attributes.ValueForKey((NSString)"NSFileSystemFreeSize").ToString());
				}
				catch (Exception) { }
		...
		internal static long TotalSpace 
		{
			get {
				...
				try {
					space = long.Parse(attributes.ValueForKey((NSString)"NSFileSystemSize").ToString());
				}
				catch (Exception) {}
