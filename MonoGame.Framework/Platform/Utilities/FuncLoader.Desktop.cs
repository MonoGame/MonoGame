    ...
    internal class FuncLoader
    {
        ...
        static IntPtr GetBrowserFunc(string function)
        {
            var ptr= function switch
            {
                ...
                // "SDL_GetWindowDisplayIndex"=>Marshal.GetFunctionPointerForDelegate(Sdl.Display.GetWindowDisplayIndex_Import),
                ...
                // "SDL_JoystickFromInstanceID"=>Marshal.GetFunctionPointerForDelegate(Sdl.GameController.JoystickFromInstanceID_Import),
