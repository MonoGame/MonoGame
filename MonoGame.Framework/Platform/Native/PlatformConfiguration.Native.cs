...
public static partial class PlatformConfiguration
{
    ...
    /// Setting a key that does not apply to the current backend is a no-op, but should be avoided.
    /// </para>
    /// <para>
    ...
    public enum PlatformConfigKey
    {
        ...
        /// <summary>
        /// Space-separated Vulkan device extension names to enable during
        /// <c>vkCreateDevice</c>.
        /// <para>
        /// <b>Type:</b> <see cref="string"/>. <b>Default:</b> <c>null</c>.
        /// </para>
