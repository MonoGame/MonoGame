...
internal static unsafe partial class MGM
{
    ...
    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_Create", StringMarshalling = StringMarshalling.Utf8)]
    ...
    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_Destroy", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_Destroy(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_GetState", StringMarshalling = StringMarshalling.Utf8)]
    public static partial MediaState Video_GetState(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_GetPosition", StringMarshalling = StringMarshalling.Utf8)]
    public static partial ulong Video_GetPosition(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_SetVolume", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_SetVolume(MGM_Video* video, float volume);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_SetLooped", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_SetLooped(MGM_Video* video, [MarshalAs(UnmanagedType.U1)] bool looped);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_Play", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_Play(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_Pause", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_Pause(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_Resume", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_Resume(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_Stop", StringMarshalling = StringMarshalling.Utf8)]
    public static partial void Video_Stop(MGM_Video* video);

    [LibraryImport(MonoGameNativeDLL, EntryPoint = "MGM_Video_GetFrame", StringMarshalling = StringMarshalling.Utf8)]
