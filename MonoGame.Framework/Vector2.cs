...
namespace Microsoft.Xna.Framework
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2"/> that contains a sum of two other vectors.
        /// </summary>
        ...
        /// <param name="value1">The first <see cref="Vector2"/>.</param>
        /// <param name="value2">The second <see cref="Vector2"/>.</param>
        /// <param name="result">Sum of the vectors as an output parameter.</param>
        ...
        /// <summary>
        /// Returns a <see cref="Point"/> representation of this <see cref="Vector2"/>.
        /// </summary>
