...
namespace Microsoft.Xna.Framework.Input.Touch
{
    class TouchPanelState
    {
        ...
        internal bool Refresh(bool consumeState)
        {
            ...
            for (var i = 0; i < _touchState.Count; i++)
            {
                ...
                for (var j = 0; j < _touchEvents.Count; j++)
                {
                    var newTouch = _touchEvents[j];
