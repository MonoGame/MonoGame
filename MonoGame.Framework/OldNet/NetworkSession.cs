...
//			gamer.PropertyChanged += HandleGamerPropertyChanged;	
        ...
        */
        ...
        {
            if (OldNet.NetworkSession.activeSessions != null && OldNet.NetworkSession.activeSessions.Count > 0)
            {
                foreach (OldNet.NetworkSession session in OldNet.NetworkSession.activeSessions)
                {
