...
MG_EXPORT mgbool MGP_Window_GetIsUsingTextInput(MGP_Window* window);
MG_EXPORT void MGP_Window_SetIsUsingTextInput(MGP_Window* window, mgbool state);
MG_EXPORT void MGP_Window_GetIMEPosition(MGP_Window* window, mgint& x, mgint& y, mgint& width, mgint& height);
MG_EXPORT void MGP_Window_SetIMEPosition(MGP_Window* window, mgint x, mgint y, mgint width, mgint height);
MG_EXPORT mgint MGP_Window_GetClipboardText(MGP_Window* window, char* textBuf, mgint bufLength);
MG_EXPORT void MGP_Window_SetClipboardText(MGP_Window* window, const char* textBuf);
