...
MG_EXPORT mgbyte* MGP_Platform_MakePath(mgbyte* location, mgbyte* path);
...
MG_EXPORT void MGP_Window_SetTitle(MGP_Window* window, mgbyte* title);
...
MG_EXPORT mgint MGP_Window_ShowMessageBox(MGP_Window* window, mgbyte* title, mgbyte* description, mgbyte* buttons, mgint count);
