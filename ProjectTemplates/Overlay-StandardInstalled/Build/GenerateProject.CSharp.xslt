...
<xsl:stylesheet
  ...
  <xsl:template name="NativeBinary"
    ...
    <None>
      ...
      <!-- MonoGame Specific Extensions -->
      <xsl:choose>
        <xsl:when test="user:IsTrue($absolute)">
          ...
          <xsl:choose>
            <xsl:when test="$root/Input/Generation/HostPlatform = 'Windows'">
              <xsl:call-template name="NativeBinary">
                ...
                <xsl:with-param name="absolute"><xsl:value-of select="$source_project/@Absolute" /></xsl:with-param>
  ...
  <xsl:template name="ReferenceToBinary"
    ...
    <Reference>
      ...
      <!-- MonoGame Specific Extensions -->
      <xsl:choose>
        <xsl:when test="user:IsTrue($binary/@Absolute)">
          <HintPath>
            <xsl:value-of select="$binary/@Path" />
          </HintPath>
        </xsl:when>
        <xsl:otherwise>
          <HintPath>
  ...
  <xsl:template match="/">
    ...
    <Project
      ...
      <PropertyGroup>
        ...
        <!-- MonoGame Specific Extensions -->
        <MonoGamePlatform><xsl:value-of select="$root/Input/Generation/Platform" /></MonoGamePlatform>
            ...
            <xsl:if test="
              ...
              <xsl:for-each select="$extern/NativeBinary">
                <xsl:call-template name="NativeBinary">
                  ...
                  <xsl:with-param name="absolute"><xsl:value-of select="$project/@Absolute" /></xsl:with-param>
