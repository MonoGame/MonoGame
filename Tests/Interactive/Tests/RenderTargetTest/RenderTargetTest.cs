...
namespace MonoGame.InteractiveTests
{
    ...
    public class RenderTargetTest : TestGame
    {
        ...
        protected override void LoadContent()
        {
            ...
            _renderTarget = new RenderTarget2D(GraphicsDevice, 512, 512, false, SurfaceFormat.Color, DepthFormat.None);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _batch.Begin();
            _batch.Draw(_texture, new Vector2(100, 50), null, Color.White);
            _batch.End();
