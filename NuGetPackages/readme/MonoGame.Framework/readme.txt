...
The goal is to make it easy for XNA developers to create cross-platform games with extremely high code reuse. We currently support iOS, Android, Windows (both OpenGL and DirectX), Mac OS X, Linux, Windows 8 Store, Windows Phone 8 and Windows UWP.
...
**Note, the platform name should be one of the following: Android, iOS, Linux, MacOSX, NativeClient, Playstation4, RaspberryPi, Windows, WindowsGL, WindowsStoreApp   (depending on your project platform)
