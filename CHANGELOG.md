...
### Added
 - Add new Plane constructor. [#6085](https://github.com/MonoGame/MonoGame/pull/6085)
 - Added Round, Ceiling, Floor functions to Vector2/3/4. [#6318](https://github.com/MonoGame/MonoGame/pull/6318)
 - Added optional TransformMatrix to SpriteEffect. [#6623](https://github.com/MonoGame/MonoGame/pull/6623)
 - Adding capacity parameter to SpriteBatch ctor. [#6682](https://github.com/MonoGame/MonoGame/pull/6682)
 - [OpenGL] Support for separate blend states per render target. [#6343](https://github.com/MonoGame/MonoGame/pull/6343)
 - Added an additional multiply operator overload to Color with the scale first. [#6747](https://github.com/MonoGame/MonoGame/pull/6747)
 - Added a couple overloads for a garbage-less BoundingBox.CreateFromPoints(). [#6743](https://github.com/MonoGame/MonoGame/pull/6743)
 - Add UseStandardPixelAddressing option. [#6621](https://github.com/MonoGame/MonoGame/pull/6621) [#6780](https://github.com/MonoGame/MonoGame/pull/6780)
 - [MGCB] Add HKCU traversal for font descriptions. [#6671](https://github.com/MonoGame/MonoGame/pull/6671)
 - Added a garbageless GetPressedKeys overload. [#6643](https://github.com/MonoGame/MonoGame/pull/6643)
 - Custom FreeImage wrapper for pipeline. [#5548](https://github.com/MonoGame/MonoGame/pull/5548)
 - FUNDING.yml file with PayPal link. [#6792](https://github.com/MonoGame/MonoGame/pull/6792)
 - Add Subscription section with Donate link to ReadMe.md. [#6802](https://github.com/MonoGame/MonoGame/pull/6802)
 - Allow discard color to be altered. [#6832](https://github.com/MonoGame/MonoGame/pull/6832)
 - Added support for buffered keyboard input. [#6762](https://github.com/MonoGame/MonoGame/pull/6762)
 - Add FromFile to Texture2D and SoundEffect. [#6586](https://github.com/MonoGame/MonoGame/pull/6586)
 - Added ability to determine the underlying game platform type during the run-time. [#6846](https://github.com/MonoGame/MonoGame/pull/6846) [#6873](https://github.com/MonoGame/MonoGame/pull/6873)
 - Add API to query graphical system at runtime. [#6872](https://github.com/MonoGame/MonoGame/pull/6872)
 - Enforce C# 5 in MonoGame.Framework assembly. [#6901](https://github.com/MonoGame/MonoGame/pull/6901)
 - Add Etc2 texture format support. [#6864](https://github.com/MonoGame/MonoGame/pull/6864)
 - Add MonoGame.Content.Builder package. [#6905](https://github.com/MonoGame/MonoGame/pull/6905)
 - Add τ constant. [#6937](https://github.com/MonoGame/MonoGame/pull/6937)
 - [UWP] Trigger vibrations and added overloads. [#6933](https://github.com/MonoGame/MonoGame/pull/6933)
 - [MGCB Editor] Always use Headerbar. [#6938](https://github.com/MonoGame/MonoGame/pull/6938)
 - Added joystick display name to the Joystick API. [#7008](https://github.com/MonoGame/MonoGame/pull/7008)
 - [OpenGL] Support base index for draw instancing. [#7016](https://github.com/MonoGame/MonoGame/pull/7016)
 ...
 - Added LastJoystickIndex to the Joystick API. [#7017](https://github.com/MonoGame/MonoGame/pull/7017)
 - Added MouseState.ToString. [#7091](https://github.com/MonoGame/MonoGame/pull/7091)
 - [MGCB Editor] Added dotnet tool. [#7090](https://github.com/MonoGame/MonoGame/pull/7090)
 - [MGFXC] Can now run under Wine. [#7098](https://github.com/MonoGame/MonoGame/pull/7098) [#7103](https://github.com/MonoGame/MonoGame/pull/7103) [#7107](https://github.com/MonoGame/MonoGame/pull/7107) [#7188](https://github.com/MonoGame/MonoGame/pull/7188)
 - Implement missing EffectParameter.SetValue for int array. [#7143](https://github.com/MonoGame/MonoGame/pull/7143)
 - Add Web platform information to the content builder. [#7144](https://github.com/MonoGame/MonoGame/pull/7144)
 - [macOS] Add a MonoGame Content pad to VS for Mac. [#7266](https://github.com/MonoGame/MonoGame/pull/7266)
 - [WindowsDX] Add .NET reference assemblies. [#7268](https://github.com/MonoGame/MonoGame/pull/7268)

### Removed
 - Remove old unused macOS files. [#6576](https://github.com/MonoGame/MonoGame/pull/6576)
 - Remove obsolete SpriteBatch.Draw(...). [#6818](https://github.com/MonoGame/MonoGame/pull/6818)
 ...
 - Remove PNG Utility Classes. [#6976](https://github.com/MonoGame/MonoGame/pull/6976)
...
### Changed
 ...
 - [macOS] Add ResourceContentManager to build. [#6578](https://github.com/MonoGame/MonoGame/pull/6578)
 ...
 - Update halfpixel calculation to SpriteBatch test. [#6779](https://github.com/MonoGame/MonoGame/pull/6779)
 - Split IRenderTarget.cs to platform specific files. [#6783](https://github.com/MonoGame/MonoGame/pull/6783)
 - [OpenGL] Move IGraphicsContext and IWindowInfo and restrict them to OpenGLGraphics. [#6782](https://github.com/MonoGame/MonoGame/pull/6782)
 - Marked Color.TransparentBlack obsolete. [#6817](https://github.com/MonoGame/MonoGame/pull/6817)
 - [SDL] Performance and garbage optimizations to Joystick. [#6829](https://github.com/MonoGame/MonoGame/pull/6829)
 - Further garbage optimizations to Joystick. [#6834](https://github.com/MonoGame/MonoGame/pull/6834)
 - Track GamePad packet number and general optimizations (fixes #5971). [#6760](https://github.com/MonoGame/MonoGame/pull/6760)
 ...
 - Updated to the latest StbSharp. [#6822](https://github.com/MonoGame/MonoGame/pull/6822)
 ...
 - Replaced PngWriter with StbImageWriteSharp. [#6867](https://github.com/MonoGame/MonoGame/pull/6867)
 ...
 - Decouple Content.Pipeline from Graphics. [#6913](https://github.com/MonoGame/MonoGame/pull/6913)
 - Move the implementation of BoundingSphere.Intersects(BoundingSphere) in the fast 'ref' method. [#6955](https://github.com/MonoGame/MonoGame/pull/6955)
 ...
 - Use short for parameter count in effect binary. [#5995](https://github.com/MonoGame/MonoGame/pull/5995)
...
### Fixed
 - Fix setting mouse cursor from Texture2D under DesktopGL. [#6187](https://github.com/MonoGame/MonoGame/pull/6187)
 ...
 - Fix AndroidCore and ContentPipeline projects after StbSharp merge. [#6851](https://github.com/MonoGame/MonoGame/pull/6851)
 - [DesktopGL] Fix library loading on Windows. [#6856](https://github.com/MonoGame/MonoGame/pull/6856)
 - Override Dispose in DrawableGameComponent to unload content. [#6858](https://github.com/MonoGame/MonoGame/pull/6858)
 - Fix path to ExternalTool for content pipeline on .NET Core. [#6863](https://github.com/MonoGame/MonoGame/pull/6863)
 ...
 - [MGCB] Rethrow InvalidContentException for Importers instead of wraping it in a new PipelineException. [#6954](https://github.com/MonoGame/MonoGame/pull/6954)
 ...
 - Fallback to less precise frame pacing on non-Windows platforms. [#6941](https://github.com/MonoGame/MonoGame/pull/6941)
 - [OpenGL] Fixed wrong calling convention for crashing on Windows x86. [#6963](https://github.com/MonoGame/MonoGame/pull/6963)
