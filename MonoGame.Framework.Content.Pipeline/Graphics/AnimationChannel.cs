...
namespace Microsoft.Xna.Framework.Content.Pipeline.Graphics
{
    ...
    /// </summary>
    public sealed class AnimationChannel : ICollection<AnimationKeyframe>
    {
        ...
        /// </summary>
        public AnimationKeyframe this[int index] => _keyframes[index];
        ...
        void ICollection<AnimationKeyframe>.Add(AnimationKeyframe item) => _keyframes.Add(item);
        ...
        public int Add(AnimationKeyframe item)
        {
            ...
            var index = _keyframes.BinarySearch(item);
            if (index >= 0)
            {
        ...
        public bool Contains(AnimationKeyframe item) => _keyframes.Contains(item);
        ...
        void ICollection<AnimationKeyframe>.CopyTo(AnimationKeyframe[] array, int arrayIndex) => _keyframes.CopyTo(array, arrayIndex);
        ...
        public int IndexOf(AnimationKeyframe item) => _keyframes.IndexOf(item);
        ...
        public bool Remove(AnimationKeyframe item) => _keyframes.Remove(item);
        ...
        public IEnumerator<AnimationKeyframe> GetEnumerator() => _keyframes.GetEnumerator();
