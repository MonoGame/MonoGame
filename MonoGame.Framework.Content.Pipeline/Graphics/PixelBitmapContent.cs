    ...
    public class PixelBitmapContent<T> : BitmapContent where T : struct, IEquatable<T>
    {
        ...
        public PixelBitmapContent(int width, int height)
        {
            if (!TryGetFormat(out _format))
                throw new InvalidOperationException($"Color format \"{typeof(T)}\" is not supported");
        ...
        public sealed override bool TryGetFormat(out SurfaceFormat format)
        {
        ...
        public T GetPixel(int x, int y) => _pixelData[y][x];
        ...
        public void SetPixel(int x, int y, T value) => _pixelData[y][x] = value;
        ...
        protected override bool TryCopyFrom(BitmapContent sourceBitmap, Rectangle sourceRegion, Rectangle destinationRegion)
        {
            ...
            else
            {
                ...
                if (new Vector4Converter() is not IVector4Converter<T> converter)
                    return false;
        ...
        protected override bool TryCopyTo(BitmapContent destinationBitmap, Rectangle sourceRegion, Rectangle destinationRegion)
        {
            ...
            if (destinationBitmap is not PixelBitmapContent<Vector4> || sourceRegion.Width != destinationRegion.Width || sourceRegion.Height != destinationRegion.Height)
            {
                try
                {
