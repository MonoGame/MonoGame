...
namespace Microsoft.Xna.Framework.Content.Pipeline.Graphics
{
    ...
    public sealed class VertexContent
    {
        ...
        public int Add(int positionIndex) => PositionIndices.Items.Add(positionIndex);
        ...
        public void AddRange(IEnumerable<int> positionIndexCollection) => PositionIndices.InsertRange(PositionIndices.Items.Count, positionIndexCollection);
        ...
        private int SetupVertexDeclaration(VertexBufferContent result)
        {
            ...
            result.VertexDeclaration.VertexElements.Add(new VertexElement(offset, VertexElementFormat.Vector3, VertexElementUsage.Position, 0));
            ...
            foreach (var channel in Channels)
            {
                ...
                if (channel.ElementType == typeof(float))
                    ...
                    throw new InvalidContentException($"Unrecognized vertex content type: '{channel.ElementType}'");

                // Try to determine the vertex usage
                if (!VertexChannelNames.TryDecodeUsage(channel.Name, out VertexElementUsage usage))
                    throw new InvalidContentException($"Unknown vertex element usage for channel '{channel.Name}'");
        ...
        public void Insert(int index, int positionIndex) => PositionIndices.Items.Insert(index, positionIndex);
        ...
        public void InsertRange(int index, IEnumerable<int> positionIndexCollection) => PositionIndices.InsertRange(index, positionIndexCollection);
        ...
        public void RemoveAt(int index)
        {
            ...
            ArgumentOutOfRangeException.ThrowIfGreaterThanOrEqual(index, VertexCount);
        ...
        public void RemoveRange(int index, int count)
        {
            ...
            ArgumentOutOfRangeException.ThrowIfGreaterThan(index + count, VertexCount);
