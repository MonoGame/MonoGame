...
namespace Microsoft.Xna.Framework.Content.Pipeline.Graphics
{
    ...
    public class PvrtcRgba2BitmapContent(int width, int height) : PvrtcBitmapContent(width, height)
    {
        /// <summary>
        ...
        public override string ToString() => $"PVRTC RGBA 2bpp {Width}x{Height}";
    }
}
