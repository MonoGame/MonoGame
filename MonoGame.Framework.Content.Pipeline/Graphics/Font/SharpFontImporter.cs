...
namespace Microsoft.Xna.Framework.Content.Pipeline.Graphics
{
    ...
    internal class SharpFontImporter : IFontImporter
    {
        ...
        /// <summary>
        /// Gets the Glyph data. the glyph must have been loaded and rendered
        /// before calling this method
        /// </summary>
        /// <param name="character">Character of the glyph, only used for populating
