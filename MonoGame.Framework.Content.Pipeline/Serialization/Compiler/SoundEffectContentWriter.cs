...
{
    [ContentTypeWriter]
    public class SoundEffectContentWriter : ContentTypeWriter<SoundEffectContent>
    {
        /// <summary>
        ...
        public override string GetRuntimeReader(TargetPlatform targetPlatform)
        {
            ...
            string readerType = type.Namespace + ".SoundEffectReader, " + type.Assembly.FullName;
            return readerType;
        }
        ...
        public override string GetRuntimeType(TargetPlatform targetPlatform)
        {
            // Base the reader type string from a known public class in the same namespace in the same assembly
            Type type = typeof(ContentReader);
            string readerType = type.Namespace + ".SoundEffectReader, " + type.AssemblyQualifiedName;
            return readerType;
        }
        ...
        {
            // Audio data does not compress well
            return false;
        }
    }
}
