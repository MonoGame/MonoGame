...
class ModelWriter : BuiltInContentWriter<ModelContent>
{
    ...
    private static void WriteBoneReference(ContentWriter output, ModelBoneContent? bone, ModelBoneContentCollection? bones)
    {
        var boneCount = bones?.Count ?? 0;
        var boneId = bone != null ? bone.Index + 1 : 0;
