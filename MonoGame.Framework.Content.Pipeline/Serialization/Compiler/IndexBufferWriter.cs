...
class IndexBufferWriter : BuiltInContentWriter<IndexCollection>
{
    ...
    public override string GetRuntimeReader(TargetPlatform targetPlatform)
        => $"{typeof(ContentReader).Namespace}.IndexBufferReader, {typeof(ContentReader).Assembly.FullName}";

    public override string GetRuntimeType(TargetPlatform targetPlatform)
        => $"{typeof(ContentReader).Namespace}.IndexBufferReader, {typeof(ContentReader).AssemblyQualifiedName}";
}
