...
{
    class Vector4Test : FPointBase
    {
        private void Compare(Vector4 expected, Vector4 source)
        {
            Assert.That(expected, Is.EqualTo(source).Using(Vector4Comparer.Epsilon));
        }
        ...
        public void Constructors()
        {
            ...
            Compare(expectedResult, new Vector4(1,2,3,4));
            Compare(expectedResult, new Vector4(new Vector2(1,2),3,4));
            Compare(expectedResult, new Vector4(new Vector3(1,2,3),4));
            Compare(expectedResult2, new Vector4(2.2f));
#if !XNA
            Compare(expectedResult, new Vector4(new Quaternion() {X=1,Y=2,Z=3,W=4}));
#endif
        }
        ...
        {
            Compare(new Vector4(0,0,0,0), Vector4.Zero);
            Compare(new Vector4(1,1,1,1), Vector4.One);
            Compare(new Vector4(1,0,0,0), Vector4.UnitX);
            Compare(new Vector4(0,1,0,0), Vector4.UnitY);
            Compare(new Vector4(0,0,1,0), Vector4.UnitZ);
            Compare(new Vector4(0,0,0,1), Vector4.UnitW);
        }
        ...
        public void Dot()
        {
            ...
            Compare(expectedResult, Vector4.Dot(vector1, vector2));
        ...
        {
            var vector1 = new Vector4(1, 2, 3, 4);
            Compare(5.477226f,vector1.Length());
        }
        ...
        {
            var vector1 = new Vector4(1, 2, 3, 4);
            Compare(30, vector1.LengthSquared());
        }
