...
namespace MonoGame.Tests.Framework
{
    public class MathHelperDTest
    {
        ...
        // Pi boundaries
        [TestCase(3.1415927f, -3.141592566167013d)]
        [TestCase(3.141593f, -3.1415923277484339d)]
        [TestCase(-3.1415925f, -3.1415925f)]
        [TestCase(-3.1415927f, 3.141592566167013d)]
        // 2 * Pi boundaries
        [TestCase(6.283185f, -3.0199159795074593E-07d)]
        [TestCase(6.2831855f, 1.7484556025237907E-07d)]
        [TestCase(6.283186f, 6.5168271845550407E-07d)]
        [TestCase(-6.283185f, 3.0199159795074593E-07d)]
        [TestCase(-6.2831855f, -1.7484556025237907E-07d)]
        [TestCase(-6.283186f, -6.5168271845550407E-07d)]
        // 3 * Pi boundaries
        [TestCase(9.424778f, -3.1415926297400318d)]
        [TestCase(9.424779f, -3.1415916760657154d)]
        [TestCase(-9.424778f, 3.1415926297400318d)]
        [TestCase(-9.424779f, 3.1415916760657154d)]
        // 4 * Pi boundaries
        [TestCase(12.56637f, -6.0398319590149185E-07d)]
        [TestCase(12.566371f, 3.4969112050475815E-07d)]
        [TestCase(12.566372f, 1.3033654369110081E-06d)]
        [TestCase(-12.56637f, 6.0398319590149185E-07d)]
        [TestCase(-12.566371f, -3.4969112050475815E-07d)]
        [TestCase(-12.566372f, -1.3033654369110081E-06d)]
        // 5 * Pi boundaries
        [TestCase(15.707963f, 3.1415923754479564d)]
        [TestCase(15.707964f, -3.1415919780573134d)]
        [TestCase(-15.707963f, -3.1415923754479564d)]
        [TestCase(-15.707964f, 3.1415919780573134d)]
        // 10 * Pi boundaries
        [TestCase(31.415926f, -5.5628367334747963E-07d)]
        [TestCase(31.415928f, 1.3510649594650204E-06d)]
        [TestCase(-31.415926f, 5.5628367334747963E-07d)]
        [TestCase(-31.415928f, -1.3510649594650204E-06d)]
        // 20 * Pi boundaries
        [TestCase(62.831852f, -1.1125673466949593E-06d)]
        [TestCase(62.831856f, 2.7021299189300407E-06d)]
        [TestCase(-62.831852f, 1.1125673466949593E-06d)]
        [TestCase(-62.831856f, -2.7021299189300407E-06d)]
        // 20000000 * Pi boundaries
        [TestCase(6.2831852E7f, -1.0717958623199593d)]
        [TestCase(6.2831856E7f, 2.9282041376800407d)]
        [TestCase(-6.2831852E7f, 1.0717958623199593d)]
        [TestCase(-6.2831856E7f, -2.9282041376800407d)]
        public void WrapAngleReturnsExpectedValues(double angle, double expectedValue)
        {
            var actualValue = MathHelperD.WrapAngle(angle);
            Assert.AreEqual(expectedValue, actualValue, 0.00000000001d);
        }
    }
}
