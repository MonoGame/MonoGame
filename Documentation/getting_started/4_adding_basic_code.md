This file will go over adding basic logic to your game. Do note that this file is a continues where [Adding Content](getting_started/3_adding_content.md) tutorial left off.
