...
namespace Marblets
{
    ...
    /// For the purposes of this code 1024x768 HD resolution is considered the base 
    /// size. Everything is sized based on its relative value to that.
    /// </summary>
    public class RelativeSpriteBatch : SpriteBatch
    {
        private const int fullHeight = 768;
        ...
        /// <param name="position">The position in 1024x768 screen space. It will 
