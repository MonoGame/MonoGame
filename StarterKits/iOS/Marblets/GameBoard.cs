...
;
            ...
            if (totalSelected > 0 && burstPressed)
            {
                if (totalSelected > 10)
                {
                    // TODO Sound.Play(SoundEntry.ClearBonus);
                }
                else
                {
                    // TODO Sound.Play(SoundEntry.ClearMarbles);
                }
            ...
            {
                //not enough marbles
                // TODO Sound.Play(SoundEntry.ClearIllegal);
            }
        ...
        private void moveCursor()
        {
            ...
            {
                // TODO Sound.Play(SoundEntry.Navigate);
                FindSelectedMarbles();
            }
        ...
        private bool moveCursorWithMouse(int x, int y)
        {
            ...
            double scale = (float)GraphicsDevice.Viewport.Height / 768.0;
            double offset = (int)((GraphicsDevice.Viewport.Width - 1024 * scale) / 2);
