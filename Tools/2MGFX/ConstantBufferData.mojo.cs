...
namespace TwoMGFX
{
    internal partial class ConstantBufferData
    {
                                ...
                                MojoShader.MOJOSHADER_symbol[] symbols)
		{
			...
			Parameters = new List<DirectXEffectObject.d3dx_parameter> ();
        ...
        private static DirectXEffectObject.d3dx_parameter GetParameterFromSymbol(MojoShader.MOJOSHADER_symbol symbol)
        {
