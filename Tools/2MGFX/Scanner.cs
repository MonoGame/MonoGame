...
namespace TwoMGFX
{
    ...
    public enum TokenType
    {
            ...
            OpenSquareBracket= 137,
            CloseSquareBracket= 138,
            LessThan= 139,
            GreaterThan= 140,
            Compile = 141,
            ShaderModel= 142,
            ...
            Point   = 165,
            Anisotropic= 166,
            AlphaBlendEnable= 167,
            SrcBlend= 168,
            DestBlend= 169,
            BlendOp = 170,
            ColorWriteEnable= 171,
            ZEnable = 172,
            ZWriteEnable= 173,
            ZFunc   = 174,
            DepthBias= 175,
            CullMode= 176,
            FillMode= 177,
            MultiSampleAntiAlias= 178,
            ScissorTestEnable= 179,
            SlopeScaleDepthBias= 180,
            StencilEnable= 181,
            StencilFail= 182,
            StencilFunc= 183,
            StencilMask= 184,
