...
namespace TwoMGFX
{
	internal partial class EffectObject
	{
	    ...
	    public void Write(BinaryWriter writer, ShaderProfile profile)
	    {
	        // Write a header for identification and versioning.
	        writer.Write(Header.ToCharArray());
	        writer.Write((byte)Version);

	        // Write a simple identifier for the shader profile
	        var id = profile.FormatId;
	        writer.Write(id);
