...
namespace MonoGame.Tools.VisualStudio
{
    ...
    public class MgfxGenerator : BaseCodeGenerator
    {
#if DEBUG
        /// <summary>
        ...
        {
            return TwoMGFX.Program.DefaultOutputFileExtension;
        }
        ...
        protected override byte[] GenerateCode(string inputFileName, string inputFileContent)
        {
            ...
            try
            {
                ...
                using (var err = new StringWriter(sb))
                {
                    ...
                    /// start a new process. Rather than adding a new method to compile to/from streams or strings
