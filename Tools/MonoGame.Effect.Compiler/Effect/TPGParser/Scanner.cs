...
namespace MonoGame.Effect.TPGParser
{
    ...
    public enum TokenType
    {
            ...
            AddressMode_Clamp= 87,
            AddressMode_Wrap= 88,
            AddressMode_Mirror= 89,
            AddressMode_Border= 90,
            AddressMode= 91,
            TextureFilter_None= 92,
            TextureFilter_Linear= 93,
            TextureFilter_Point= 94,
            TextureFilter_Anisotropic= 95,
            TextureFilter= 96,
            Sampler_State_Texture= 97,
            Sampler_State_MinFilter= 98,
            Sampler_State_MagFilter= 99,
            Sampler_State_MipFilter= 100,
            Sampler_State_Filter= 101,
            Sampler_State_AddressU= 102,
            Sampler_State_AddressV= 103,
            Sampler_State_AddressW= 104,
            Sampler_State_BorderColor= 105,
            Sampler_State_MaxMipLevel= 106,
            Sampler_State_MaxAnisotropy= 107,
            Sampler_State_MipLodBias= 108,
            Sampler_State_Expression= 109,
            Sampler_Register_Expression= 110,
            Sampler_Declaration_States= 111,
            Sampler_Declaration= 112,
            ...
            OpenSquareBracket= 140,
            CloseSquareBracket= 141,
            LessThan= 142,
            GreaterThan= 143,
            Compile = 144,
            ShaderModel= 145,
